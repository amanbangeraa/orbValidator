...
class Config:
    ...
    MIN_GOOD_MATCHES = 20  # Minimum number of good matches required
    MIN_INLIER_RATIO = 0.3  # Minimum ratio of inliers to good matches (30%)
    ...
    VERBOSE = True  # Enable detailed output logging